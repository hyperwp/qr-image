...
export function get_options(options, force_type) {
...
export function qr_image(text, options) {
...
export function qr_image_sync(text, options) {
    options = get_options(options);
...
export function svg_object(text, options) {
